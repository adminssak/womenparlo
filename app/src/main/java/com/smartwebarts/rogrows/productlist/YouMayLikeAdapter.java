...
public class YouMayLikeAdapter extends RecyclerView.Adapter<YouMayLikeAdapter.MyViewHolder>{

    private Context context;
    private List<ProductModel> list;

    public YouMayLikeAdapter(Context context, List<ProductModel> list) {
    ...
    @NonNull
    @Override
    public YouMayLikeAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new YouMayLikeAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.youmaylike_list_item, parent, false));
    }

    @SuppressLint("UseCompatLoadingForDrawables")
    @Override
    public void onBindViewHolder(@NonNull YouMayLikeAdapter.MyViewHolder holder, final int position) {
