...
public class BestSellerAdapter extends RecyclerView.Adapter<BestSellerAdapter.MyViewHolder>{
    ...
    public BestSellerAdapter(Context context, List<ProductModel> list) {
    ...
    public BestSellerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BestSellerAdapter.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.beast_saller_item_layout, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull BestSellerAdapter.MyViewHolder holder, final int position) {
