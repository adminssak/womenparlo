                    ...
                    if (preferences != null) {
                        if (!preferences.getLoginUserLoginId().isEmpty()) {
                            ...
                            if (UtilMethods.INSTANCE.isNetworkAvialable(context)) {
                                ...
                                UtilMethods.INSTANCE.removewishlist(context, list.get(WishlistGridAdapter.MyViewHolder.this.getAdapterPosition()).getId(),
                                        ...
                                        , new mCallBackResponse() {
                                            ...
                                            public void success(String from, String message) {
                                                ...
                                                if (response != null && response.getMessage() != null && response.getMessage().equalsIgnoreCase("success")) {
                                                    ProductModel temp = list.get(MyViewHolder.this.getAdapterPosition());
                                                    list.remove(temp);
